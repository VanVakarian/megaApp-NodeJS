...
- убедиться, что WebSocket `GET /api/ws?...` открывается со статусом `101 Switching Protocols`; в локальном run при frontend на `:4200` или `:4201` он должен идти прямо на backend `:3001`
